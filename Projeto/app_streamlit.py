...
if arquivo:
    ...
    if X.shape[0] == 0 or len(y) == 0:
        st.warning("Sem dados suficientes para regressão.")
        st.stop()
    ...
    with col1:
        ...
        fig1.update_layout(
            title=f"Linear: y = {a:.4f} + {b:.4f}x | R²={r2:.4f}"
        )
